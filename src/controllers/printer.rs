...
use crate::models::_entities::printers::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
        ...
        item.ip = Set(self.ip.clone());
        item.port = Set(self.port.clone());
        item.active = Set(self.active.clone());
        item.model_id = Set(self.model_id.clone());
        item.location_id = Set(self.location_id.clone());
    }
}
